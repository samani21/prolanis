...
<html>
    ...
    <nav class="sidebar">
        ...
        <div class="header">Tambah Nilai Kelas 10B</div>
        <div class="info">
        <head>
            <meta charset="utf-8">
        ...
        <form action="" method ="post">
                    ...
                    <div class="form-group row">
                        <label for="colFormLabel" class="col-sm-2 col-form-label">EKONOMI</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="ekonomi" id="ekonomi">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="colFormLabel" class="col-sm-2 col-form-label">SOSIAL</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="sosial" id="sosial">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="colFormLabel" class="col-sm-2 col-form-label">GEOGRAFI</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="geografi" id="geografi">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <button type="submit" class="btn btn-primary mb-2" name="proses">Submit</button>
                        ...
                        <script type="text/javascript">
                            ...
                            var d = parseFloat($("#ekonomi").val());
                            var e = parseFloat($("#sosial").val());
                            var f = parseFloat($("#geografi").val());
                    ...
                    <?php
                        ...
                        mysqli_query($koneksi,"INSERT INTO nilai_10b set
                        nis= '$_POST[nis]',
                        nama= '$_POST[nama]',
                        b_indo= '$_POST[b_indo]',
                        b_ing= '$_POST[b_ing]',
