        ...
        <form action="" method="post">
            <div class="row g-2">
                ...
                <input type="hidden" value="<?php echo $data['alamat']?>" name="alamat">
                    ...
                    <div>
                        <label for="">TB</label>
                        <input class="form-control form-control-sm" type="text" value="<?php echo $data['tb']?>" placeholder="Masukkan TB" name="tb" id="tb"
                            aria-label="default input example" autofocus required>
                    </div>
                    <div>
                        <label for="">BB</label>
                        <input class="form-control form-control-sm" type="text" value="<?php echo $data['bb']?>" placeholder="Masukkan BB" name="bb" id="bb"
                            aria-label="default input example" required>
                    </div>
                    <div>
                        <label for="">BMI</label>
                        <input class="form-control form-control-sm" type="text" value="<?php echo $data['bmi']?>" placeholder="Masukkan BMI" name="bmi" id="bmi"
                ...
                <div class="col-6">
                    ...
                    <div>
                        ...
                        <input class="form-control form-control-sm" type="text" placeholder="Masukkan HbA1C" name="hba1c" value="<?php echo $data['hba1c']?>"
                            aria-label="default input example" required>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <select class="form-select" size="4" name="keterangan" multiple aria-label="multiple select example" required>
                            <option selected value="<?php echo $data['keterangan'] ?>"><?php echo $data['keterangan'] ?></option>
